...
<?php
    if (isset($HTTP_GET_VARS['cID'])) {
      ...
      $orders_query_raw = "select o.orders_id, o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.date_purchased, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from " . TABLE_ORDERS . " o left join " . TABLE_ORDERS_TOTAL . " ot on (o.orders_id = ot.orders_id), " . TABLE_ORDERS_STATUS . " s where o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' and ot.class = 'ot_total' order by o.date_purchased DESC";
    }
if(!$HTTP_GET_VARS['page']) { $HTTP_GET_VARS['page'] = 0;} else { $HTTP_GET_VARS['page'] = $HTTP_GET_VARS['page']; }
