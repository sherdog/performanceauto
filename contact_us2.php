    ...
    <td width="100%" valign="top"><form action="contact_us.php?action=send" method="post" onSubmit="MM_validateForm('usersname','','R','email','','RisEmail');return document.MM_returnValue">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		  	<td class="main"><strong>Our Address:<br>
		  	  </strong>PERFORMANCE AUTO <br>
		  	  2801 Falls Ave. <br>
		  	  Waterloo, Iowa 50701<br>		  	  
		  	  1-800-682-7166<br>
              <strong>store hours are:<br> 
Weekdays 8:30 - 5:00 CST and <br>
Saturday 8:30 - 12:00.		  	  </strong><br></td>
		  </tr>
		  <tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td><textarea name="enquiry" cols="70" rows="6" id="enquiry">[ please include your full address when requesting a catalog in this box ]
</textarea></td>
              </tr>
            </table></td>
          </tr>
