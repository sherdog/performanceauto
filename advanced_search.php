...
<?php
  ...
  $info_box_contents[] = array('align' => 'right', 'text' => tep_draw_checkbox_field('search_in_description', '1') . ' ' . '<span style="color:black; font-size:10px; font-weight:bold; font:verdana;">Search in desciption</span>');
